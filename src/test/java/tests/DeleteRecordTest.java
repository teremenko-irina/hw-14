...
public class DeleteRecordTest extends WebTables {
    public DeleteRecordTest(WebDriver driver) {
        super(driver);
    }
   ...
   // public void deleteRecordTest() {
        ...
        Assert.assertTrue(isRecordDeleted, "Record was not deleted successfully.");
